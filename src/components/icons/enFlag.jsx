    ...
    >
        ...
        >
            ...
            <path
                ...
                style={{ fill: 'rgb(204,0,0)' }}
            />
            <path d="M 9.605 72.771" style={{ fill: 'rgb(0,0,102)' }} />
            <path d="M 80.412 17.251" style={{ fill: 'rgb(0,0,102)' }} />
            <path d="M 80.395 72.77" style={{ fill: 'rgb(0,0,102)' }} />
            <path d="M 9.589 17.25" style={{ fill: 'rgb(0,0,102)' }} />
            <path
                d="M 9.589 17.249 l 20.416 10.208 v -3.99 V 2.584 C 21.874 5.458 14.813 10.593 9.589 17.249 z"
                style={{ fill: 'rgb(0,0,102)' }}
            />
            <path
